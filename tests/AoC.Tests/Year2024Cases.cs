...
public class Year2024Cases : IEnumerable
{
	public IEnumerator GetEnumerator()
	{
		...
		yield return new PartInputCaseData(20, 1, "1490");
		...
		yield return new PartInputCaseData(24, 1, "63168299811048");
		yield return new PartInputCaseData(24, 2, "dwp,ffj,gjh,jdr,kfm,z08,z22,z31");
		yield return new PartInputCaseData(25, 1, "3255");
	}
}